...
public class MyPasswordField extends JPasswordField {
    ...
    public MyPasswordField() {
        ...
        setSelectionColor(new Color(0, 0, 0, 50));
    }
   ...
   @Override
        ...
        g2.setStroke(new BasicStroke(2)); // Set stroke width (2px in this case)
        g2.setColor(Color.WHITE); // Set border color to white
        g2.drawRoundRect(0, 0, getWidth() - 2, getHeight() - 2, 30, 30); // Draw rounded border
        paintIcon(g);
